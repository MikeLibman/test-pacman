//
// BottomWallTile.cs: 
//   Handles the bottom wall tile logic
//
// Author:
//   Michael Libman
//
...
public class BottomWallTile : BaseTile 
{
    #region Unity API
    private void Awake()
    {
        gameObject.name = "BottomWall"; // Set gameobject name to find sprite with the same name
